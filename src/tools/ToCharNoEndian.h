...
#ifndef _TOCHARNOENDIAN_H_
#define _TOCHARNOENDIAN_H_

class ToCharNoEndian
{
public:
    static void intToChar(unsigned char * toWrite, int value);
    static void uintToChar(unsigned char * toWrite, unsigned int value);
